        ...
        <div className="container">
            <div className="navBar">
                <div className="navBar">
                    ...
                    <div className="MenuCaseItem">
                        <Link className="MenuCase" to={{ pathname: '/buyCrypto', state: props.location.state }}><img className="MenuIcon" src={menuIcoins['./credit-card.png']} alt="Sell icon"></img>Продать</Link>
                    </div>
                    <div className="MenuCaseItem">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="secondCoinPanel">
                                <label>
                                    ...
                                    <br />
                                    <br />
                                    <input className='recieverIdInput' type="number" placeholder="Введите UP-id получателя" onChange={handleRecieverIdChange} />
                                </label>
                            </div>
